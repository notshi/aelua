...
footer=function(d)
	...
	if not d.api_time then
		d.api_time=math.ceil( (cache.api_time + data.api_time)*1000 )/1000
	end
	...
	d.report=d.report or "Page generated by <a href=\"http://code.google.com/p/aelua/\">aelua</a>"..mods.." in "..(d.time or 0).."("..(d.api_time or 0)..") seconds with "..(data.count or 0).." queries and "..(cache.count_got or 0).."/"..(cache.count or 0).." caches."
