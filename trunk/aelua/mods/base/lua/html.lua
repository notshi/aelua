...
footer=function(d)
	...
	d.report=d.report or "Page generated by <a href=\"http://code.google.com/p/aelua/\">aelua</a>"..mods.." in "..(d.time or 0).."("..(d.api_time or 0)..") seconds with "..((cache.count or 0)+(data.count or 0)).." queries and "..(cache.count_got or 0).."/"..(cache.count or 0).." caches."
